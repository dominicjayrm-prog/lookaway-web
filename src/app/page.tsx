  ...
  return (
    <>
      ...
      <div style={{
        ...
        {/* NAV */}
        <header style={{ maxWidth: 960, margin: "0 auto", padding: "16px 24px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <main>
            ...
            <div className="hero-layout" style={{
              ...
              <div className="hero-text" style={{ flex: "1 1 320px", maxWidth: 420, position: "relative", zIndex: 1 }}>
                ...
                <div className="fu fu2" style={{ display: "flex", gap: 12, marginTop: 28, alignItems: "center", flexWrap: "wrap" }}>
                  <AppStoreButton />
                  <span style={{ fontSize: 13, color: P.textD }}>Free to play</span>
                </div>
              ...
              <div className="phone-bob" style={{ flexShrink: 0, position: "relative", zIndex: 1 }} aria-hidden="true">
          ...
          {/* HOW IT WORKS */}
          <section style={{ maxWidth: 960, margin: "0 auto", padding: "70px 24px", textAlign: "center" }} aria-label="How it works">
            ...
            <h2 style={{ fontSize: 34, fontWeight: 800, color: P.text, marginBottom: 44 }}>Three steps. Pure memory.</h2>
              ...
              {[
                {
                  ...
                  color: P.accent,
                  icon: <svg width="34" height="24" viewBox="0 0 36 24" aria-hidden="true"><path d="M2 12Q18 0 34 12Q18 24 2 12Z" fill={`${P.accent}12`} stroke={P.accent} strokeWidth="1.5" /><circle cx="18" cy="12" r="5" fill={P.accent} /><circle cx="18" cy="12" r="2.5" fill="white" /></svg>
                },
                {
                  step: "2", title: "Look Away",
                  desc: "The scene vanishes completely. Everything disappears. Now it's just you and your memory.",
                  color: P.coral,
                  icon: <svg width="34" height="24" viewBox="0 0 36 24" aria-hidden="true"><path d="M2 14 Q18 14 34 14" stroke={P.coral} strokeWidth="2.5" strokeLinecap="round" fill="none" /><line x1="11" y1="16" x2="8" y2="22" stroke={P.coral} strokeWidth="1.8" strokeLinecap="round" /><line x1="18" y1="16" x2="18" y2="23" stroke={P.coral} strokeWidth="1.8" strokeLinecap="round" /><line x1="25" y1="16" x2="28" y2="22" stroke={P.coral} strokeWidth="1.8" strokeLinecap="round" /></svg>
                },
                {
                  step: "3", title: "Answer",
                  desc: "Five questions test what you saw. Colours, positions, counts. How much did you really remember?",
                  color: P.green,
                  icon: <svg width="28" height="28" viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="10" fill={`${P.green}12`} stroke={P.green} strokeWidth="1.5" /><text x="12" y="16" textAnchor="middle" fill={P.green} fontSize="13" fontWeight="700">?</text></svg>
                },
              ].map((item, i) => (
                <article key={i} style={{
                  ...
                  <h3 style={{ fontSize: 20, fontWeight: 700, color: P.text, marginBottom: 8 }}>{item.title}</h3>
                  <p style={{ fontSize: 14, color: P.textM, lineHeight: 1.55 }}>{item.desc}</p>
                </article>
              ))}
            </div>
          </section>
          ...
          {/* WORLDS */}
          <section style={{ maxWidth: 960, margin: "0 auto", padding: "40px 24px 70px" }} aria-label="Game worlds">
            <div style={{ textAlign: "center", marginBottom: 36 }}>
              ...
              <h2 style={{ fontSize: 34, fontWeight: 800, color: P.text, marginBottom: 8 }}>From simple to impossible</h2>
              <p style={{ fontSize: 15, color: P.textM, maxWidth: 480, margin: "0 auto" }}>200 levels across 6 worlds. Each introduces new mechanics that layer on top of the last.</p>
            </div>
          ...
          <section style={{
            ...
            <h2 style={{ fontSize: 34, fontWeight: 800, color: P.text, marginBottom: 8 }}>Who remembers more?</h2>
            <p style={{ fontSize: 15, color: P.textM, maxWidth: 440, margin: "0 auto 36px", lineHeight: 1.6 }}>Same scenes. Same questions. Head-to-head. Pure skill, zero luck.</p>
            <div style={{
          ...
          {/* FEATURES */}
          <section style={{ maxWidth: 960, margin: "0 auto", padding: "50px 24px 70px" }} aria-label="Features">
            <div style={{ display: "flex", gap: 16, justifyContent: "center", flexWrap: "wrap" }}>
              {[
                {
                  title: "Visual memory", desc: "Train your brain to hold more visual information", color: P.accent,
                  icon: <svg width="24" height="24" viewBox="0 0 24 24" aria-hidden="true"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2z" fill="none" stroke={P.accent} strokeWidth="1.8" /><path d="M12 6v6l4 2" fill="none" stroke={P.accent} strokeWidth="1.8" strokeLinecap="round" /><circle cx="12" cy="12" r="2" fill={P.accent} /></svg>
                },
                {
                  title: "Quick sessions", desc: "Each level takes 30-60 seconds. Play anywhere.", color: P.gold,
                  icon: <svg width="24" height="24" viewBox="0 0 24 24" aria-hidden="true"><polygon points="13,2 3,14 12,14 11,22 21,10 12,10" fill="none" stroke={P.gold} strokeWidth="1.8" strokeLinejoin="round" /></svg>
                },
                {
                  title: "Track progress", desc: "Watch your memory score improve over time", color: P.green,
                  icon: <svg width="24" height="24" viewBox="0 0 24 24" aria-hidden="true"><polyline points="4,18 9,12 13,15 20,6" fill="none" stroke={P.green} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /><polyline points="16,6 20,6 20,10" fill="none" stroke={P.green} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /></svg>
                },
                {
                  title: "Earn achievements", desc: "Unlock badges and climb the ranks", color: P.coral,
                  icon: <svg width="24" height="24" viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="9" r="6" fill="none" stroke={P.coral} strokeWidth="1.8" /><path d="M8,14 L6,22 L12,19 L18,22 L16,14" fill="none" stroke={P.coral} strokeWidth="1.8" strokeLinejoin="round" /></svg>
                },
              ].map((f, i) => (
                <article key={i} style={{
                  ...
                  <h3 style={{ fontSize: 14, fontWeight: 700, color: P.text, marginBottom: 4 }}>{f.title}</h3>
                  <p style={{ fontSize: 12, color: P.textD, lineHeight: 1.5 }}>{f.desc}</p>
                </article>
              ))}
            </div>
          </section>
          ...
          <section style={{
            ...
            <h2 style={{ fontSize: 38, fontWeight: 800, color: P.text, marginBottom: 10, letterSpacing: -0.5 }}>Ready to test your memory?</h2>
            <p style={{ fontSize: 16, color: P.textM, marginBottom: 28 }}>Free to play. No account required to start.</p>
            <a
              href={APP_STORE_URL}
              target="_blank"
              rel="noopener noreferrer"
