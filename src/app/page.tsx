          ...
          >
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 10 }}>
              {[
                ...
                { href: '/memory-games-for-nurses', label: 'For nurses' },
                { href: '/free-memory-game-iphone', label: 'Free for iPhone' },
                ...
                { href: '/lumosity-alternative', label: 'Lumosity alternative' },
                { href: '/peak-alternative', label: 'Peak alternative' },
                { href: '/human-benchmark-alternative', label: 'Human Benchmark alternative' },
                { href: '/does-brain-training-work', label: 'Does brain training work?' },
                { href: '/visual-memory-exercises', label: 'Visual memory exercises' },
                { href: '/working-memory-exercises-for-adults', label: 'Working memory exercises' },
                { href: '/how-to-remember-names', label: 'How to remember names' },
                { href: '/how-to-remember-where-you-put-things', label: 'How to remember where you put things' },
                { href: '/memory-test', label: 'Free visual memory test' },
                { href: '/sequence-memory-test', label: 'Sequence memory test' },
                { href: '/number-memory-test', label: 'Number memory test' },
