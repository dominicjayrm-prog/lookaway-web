      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "40px 24px 80px" }}>
        ...
        <div style={{ marginBottom: 48 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "140px 1fr", gap: "8px 20px", fontSize: 16, color: P.textM, lineHeight: 1.7 }}>
            ...
            <span style={{ fontWeight: 600, color: P.text }}>Content</span><span>400+ levels across 6 game modes</span>
        ...
        <div style={{ marginBottom: 48 }}>
          ...
          <p style={{ fontSize: 16, color: P.textM, lineHeight: 1.7, marginBottom: 12 }}>
            The game spans 400+ levels across 6 modes, each introducing new mechanics: from basic shape recognition to moving objects, photographic scenes, and the ultimate &ldquo;Mastermind&rdquo; mode that combines everything. Difficulty ramps gradually, making the game accessible to casual players while providing a genuine challenge for memory enthusiasts.
          </p>
