...
export const metadata: Metadata = {
  ...
  description: 'Blanked is a free memory training game backed by science. Study the scene, it disappears, answer from memory. 6 game modes, 400+ levels. Play free on iOS.',
  ...
  openGraph: {
    ...
    description: 'Blanked is a free memory training game. Study the scene, it disappears, answer from memory. 6 game modes, 400+ levels. Free to play on iOS.',
    siteName: 'Blanked',
  ...
  twitter: {
    ...
    title: 'Blanked - Free Memory Training Game | Train Your Brain in 2 Minutes',
    description: 'Blanked is a free memory training game. Study the scene, it disappears, answer from memory. 6 game modes, 400+ levels. Free on iOS.',
