...
export default function PhoneMockup() {
  ...
  const [activeQ, setActiveQ] = useState(0);   // 0 = none, 1 = Q1, 2 = Q2
    ...
    <div style={{ position: "relative", width: 260, height: 520 }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          {/* Screen content area */}
          <div style={{ padding: "40px 14px 12px", flex: 1, display: "flex", flexDirection: "column" }}>
            ...
            {/* Timer bar */}
            <div style={{ height: 4, borderRadius: 2, background: "#EEEDE8", marginBottom: 10, overflow: "hidden" }}>
              <div style={{
            ...
            <div style={{
              ...
              {(phase === 'scene' || phase === 'fade') && (
                <div style={{
                  ...
                  <div style={{
                    ...
                    fontSize: 10, color: P.textD, fontWeight: 600, whiteSpace: "nowrap"
                  }}>Memorise this scene!</div>

                  {/* Red circle */}
                  <div style={{
                    position: "absolute", left: "15%", top: "12%",
                    width: 38, height: 38, borderRadius: "50%", background: P.coral,
                    boxShadow: `0 2px 8px ${P.coral}30`
                  }} />
                  {/* Blue square */}
                  <div style={{
                    position: "absolute", right: "16%", top: "15%",
                    width: 32, height: 32, borderRadius: 6, background: P.blue,
                    boxShadow: `0 2px 8px ${P.blue}30`
                  }} />
                  {/* Gold star */}
                  ...
                  {/* Purple diamond */}
                  <div style={{ position: "absolute", left: "14%", bottom: "15%" }}>
                    <svg viewBox="0 0 100 100" width="28" height="28">
                      <polygon points="50,5 95,50 50,95 5,50" fill={P.accent} />
                    </svg>
                  </div>
                  {/* Green triangle */}
                  <div style={{ position: "absolute", right: "15%", bottom: "18%" }}>
                    <svg viewBox="0 0 100 100" width="36" height="36">
                      <polygon points="50,8 92,88 8,88" fill={P.green} />
                    </svg>
                  </div>
                </div>
              )}
              ...
              {phase === 'fade' && (
                <div style={{
                  ...
                  <ClosedEyeIcon />
                  <span style={{ fontSize: 11, fontWeight: 700, color: P.accent }}>Scene disappeared!</span>
                </div>
              )}
                  ...
                  <div style={{ display: "flex", justifyContent: "center", gap: 4, marginBottom: 8 }}>
                    {[1, 2, 3, 4, 5].map(i => (
                      <div key={i} style={{
                        ...
                        background: i < activeQ ? P.green
                          : i === activeQ ? (answered ? P.green : P.accent)
                          : "#E8E6E1"
                      }} />
                    ))}
                  </div>

                  <div style={{ fontSize: 8, color: P.textD, fontWeight: 700, marginBottom: 4, letterSpacing: 0.5, textAlign: "center" }}>
                    {q.label}
                  </div>
                  <div style={{ fontSize: 12, fontWeight: 700, color: P.text, marginBottom: 10, lineHeight: 1.3, textAlign: "center" }}>
                    {q.text}
                  </div>
                  ...
                  {q.options.map((opt, i) => {
                    ...
                    return (
                      <div key={i} style={{
                        ...
                        border: highlight ? `2px solid ${P.green}` : "2px solid transparent",
            ...
            {/* Power-up hint buttons */}
            {phase === 'question' && (
              <div style={{ display: "flex", justifyContent: "center", gap: 10, marginTop: 8 }}>
                {/* Eye hint */}
                <div style={{ width: 32, height: 32, borderRadius: 8, background: "#F5F4F0", display: "flex", alignItems: "center", justifyContent: "center", opacity: 0.5 }}>
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke={P.textD} strokeWidth="1.8"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" /><circle cx="12" cy="12" r="3" /></svg>
                </div>
                {/* Scissors hint */}
                <div style={{ width: 32, height: 32, borderRadius: 8, background: "#F5F4F0", display: "flex", alignItems: "center", justifyContent: "center", opacity: 0.5 }}>
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke={P.textD} strokeWidth="1.8"><circle cx="6" cy="6" r="3" /><circle cx="6" cy="18" r="3" /><line x1="20" y1="4" x2="8.12" y2="15.88" /><line x1="14.47" y1="14.48" x2="20" y2="20" /><line x1="8.12" y1="8.12" x2="12" y2="12" /></svg>
                </div>
                {/* Skip hint */}
                <div style={{ width: 32, height: 32, borderRadius: 8, background: "#F5F4F0", display: "flex", alignItems: "center", justifyContent: "center", opacity: 0.5 }}>
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke={P.textD} strokeWidth="1.8"><polygon points="5,4 15,12 5,20" /><line x1="19" y1="5" x2="19" y2="19" /></svg>
                </div>
              </div>
            )}
          </div>
